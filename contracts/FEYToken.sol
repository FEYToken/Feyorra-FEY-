...
contract FEYToken is Token {
    ...
    /**
        ...
        * Lowers the default interest rate as amount staked risees towards the totalSupply.
   ...
   /**
    ...
    /**
        ...
        * Note: this does not calculate a return rate, only what the sum would be if the stake was clsoed at that moment
        * @param _stakingId ID of the stake, used as the Key from the stakeList mapping
    ...
    /**
        ...
        * No interest is accrued unless the stake is atleast on its 4th day
